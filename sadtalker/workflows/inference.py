...
def sad_talker_wf(
    model_params: ModelParams = ModelParams(
        ...
        # enhancer="gfpgan",
        preprocess="full",
        driven_audio="https://huggingface.co/datasets/Samhita/SadTalkerData/resolve/main/ariana-grande-7-rings-official-videomov_Cw4pymAu.mp3",
        # source_image="https://user-images.githubusercontent.com/27777173/233367190-ffed7947-06ec-4609-baad-742ede1327b2.jpg",
